...
import { ChevronLeft, ChevronRight, AlertTriangle, Plus, ChevronRight as ViewIcon } from 'lucide-react'
    ...
    <div className="p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border bg-card p-3">
          ...
          <p className="text-2xl font-bold mt-1 text-orange-500">{openCount ?? 0}</p>
        </div>
        <div className="rounded-lg border bg-card p-3">
          <p className="text-xs text-muted-foreground">Critical Open</p>
          <p className="text-2xl font-bold mt-1 text-red-500">{criticalCount ?? 0}</p>
        </div>
        <div className="rounded-lg border bg-card p-3">
          <p className="text-xs text-muted-foreground">Auto-Blocked</p>
          <p className="text-2xl font-bold mt-1 text-red-600">{autoBlockedCount ?? 0}</p>
        </div>
      </div>
