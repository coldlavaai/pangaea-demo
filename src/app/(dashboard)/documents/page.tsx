  ...
  return (
    <div className="p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatsCard title="Expired" value={counts.expired} />
        <StatsCard title={`Critical (≤${EXPIRY_CRITICAL_DAYS}d)`} value={counts.critical} />
        <StatsCard title={`Warning (≤${EXPIRY_WARNING_DAYS}d)`} value={counts.warning} />
        <StatsCard title="Valid / No expiry" value={counts.ok} />
      </div>
