...
<p>You've been added as <strong>{{role_label}}</strong> on the Pangaea platform.</p>
<p>{{role_note}}</p>
        ...
        <tr><td style="background:#0d1f3c;padding:16px 24px;border-bottom:1px solid #1e3a5f;">
          <table width="100%" cellpadding="0" cellspacing="0"><tr>
            <td>
              ...
              <p style="margin:0;font-size:13px;color:#94a3b8;">@PangaeaSiteBot is your main tool for managing operatives on site.</p>
            </td>
        ...
        <tr><td style="padding:20px 24px;">
          ...
          <table cellpadding="0" cellspacing="0" style="margin-bottom:20px;"><tr>
            <td style="background:#1d4ed8;border-radius:7px;box-shadow:0 3px 10px rgba(29,78,216,0.4);">
              <a href="https://t.me/PangaeaSiteBot" style="display:inline-block;padding:11px 22px;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">
                Open @PangaeaSiteBot in Telegram &#8594;
              </a>
            </td>
          </tr></table>
          ...
          ${tgStep('1', 'Open @PangaeaSiteBot', 'Tap the blue button above or search @PangaeaSiteBot in Telegram, then press <strong style="color:#e2e8f0;">Start</strong>.')}
    ...
    return `<tr><td style="padding:0 32px 28px;">
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a1628;border-radius:10px;border:1px solid #1e3a5f;overflow:hidden;">
        ...
        <tr><td style="padding:20px 24px;">
          ...
          ${tgStep('4', 'Open @RexNotifyBot',
            `Message <a href="https://t.me/RexNotifyBot" style="color:#38bdf8;text-decoration:none;font-weight:600;">@RexNotifyBot</a> on Telegram to access the live query menu. Use the buttons to check unread alerts, pending requests, open NCRs, and platform status — any time.`)}

          <!-- Open bot CTA -->
          <table cellpadding="0" cellspacing="0" style="margin-top:18px;margin-bottom:8px;"><tr>
            <td style="background:#1d4ed8;border-radius:7px;box-shadow:0 3px 10px rgba(29,78,216,0.4);">
              <a href="https://t.me/RexNotifyBot" style="display:inline-block;padding:11px 22px;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;">
                Open @RexNotifyBot &#8594;
              </a>
            </td>
          </tr></table>
      ...
      <table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;background:#111827;border-radius:12px;border:1px solid #1f2937;overflow:hidden;">
        ...
        <tr>
          <td style="background:#0f172a;padding:24px 32px;border-bottom:1px solid #1f2937;">
            <table width="100%" cellpadding="0" cellspacing="0"><tr>
              <td>
                <p style="margin:0;font-size:22px;font-weight:800;color:#ffffff;letter-spacing:3px;">Rex</p>
                <p style="margin:2px 0 0;font-size:10px;color:#4b5563;letter-spacing:2px;text-transform:uppercase;">Pangaea</p>
              </td>
              <td align="right">
        ...
        <tr>
          <td style="background:#0f172a;border-top:1px solid #1f2937;padding:16px 32px;">
            <p style="margin:0;font-size:11px;color:#374151;">Pangaea · Pangaea Ltd · This is an automated message.</p>
          </td>
        </tr>
...
export const TEMPLATE_DEFINITIONS: TemplateDefinition[] = [
  {
    ...
    defaultSubject: `You've been invited to Pangaea`,
