...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="shrink-0 text-muted-foreground hover:text-forest-400 transition-colors"
        ...
        <>
          <div className="space-y-1.5">
            ...
            <Select value={requestId} onValueChange={setRequestId}>
              ...
              <SelectContent className="bg-card border-border">
                ...
                {requests.map((r) => (
                  <SelectItem key={r.id} value={r.id} className="text-muted-foreground">
          ...
          <div className="rounded-lg border border-border bg-card/30 p-4 space-y-4">
            <div className="flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-forest-400" />
              <h3 className="text-sm font-medium text-muted-foreground">Generate ad copy with AI</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                <Label className="text-xs text-muted-foreground">Extra info (optional)</Label>
                <Input
                  value={aiDescription}
            ...
            <Button
              ...
              disabled={generating}
              className="bg-forest-600 hover:bg-forest-500 text-white h-8 text-xs"
            >
              {generating
            ...
            {generated && (
              <div className="space-y-3 pt-1">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start gap-2 rounded-md bg-background/60 border border-border px-3 py-2">
                    <p className="flex-1 text-sm text-muted-foreground font-medium leading-relaxed">{generated.headline}</p>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start gap-2 rounded-md bg-background/60 border border-border px-3 py-2">
                    <p className="flex-1 text-sm text-muted-foreground leading-relaxed whitespace-pre-line">{generated.facebook_body}</p>
                ...
                {/* Short version */}
                <div className="space-y-1">
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Short (Instagram / X)</p>
                  <div className="flex items-start gap-2 rounded-md bg-background/60 border border-border px-3 py-2">
                    <p className="flex-1 text-sm text-muted-foreground leading-relaxed">{generated.short_version}</p>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start gap-2 rounded-md bg-background/60 border border-border px-3 py-2">
                    <p className="flex-1 text-sm text-forest-400 font-mono leading-relaxed">{generated.hashtags}</p>
